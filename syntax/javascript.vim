...
syntax region  jsClassBlock         contained matchgroup=jsClassBraces         start=/{/  end=/}/  contains=jsClassFuncName,jsConstructor,jsClassMethodType,jsArrowFunction,jsArrowFuncArgs,jsComment,jsGenerator,jsDecorator,jsClassProperty,jsClassPropertyComputed,jsClassStringKey,jsAsyncKeyword,jsNoise extend fold
...
syntax match   jsConstructor            contained /\<constructor\>/ skipwhite skipempty nextgroup=jsFuncArgs,jsFlowClassFunctionGroup
...
if version >= 508 || !exists("did_javascript_syn_inits")
  ...
  HiLink jsClassDefinition      Class
